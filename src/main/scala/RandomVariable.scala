...
import graduatework.GraduateWork.expFolder
...
case class RandomVariableToStorage(name: String, distribution: Distribution, record: Boolean = true,
                                   countOfVariables: Int = GraduateWork.randomVariableCount,
                                   integralCount: Int = GraduateWork.integralCount) extends RandomVariable {
